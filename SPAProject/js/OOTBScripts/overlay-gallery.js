//Default Angular service declaration.
myApp.service('overlayGalleryScriptExec', function () {
    return {

        //service has one function - runTimedOut();
        runTimedOut: function () {

            //setTimeout wrapps the default JS logic of the control.
            setTimeout(function () {

                //this is default JS logic of the control.
                ; (function ($) {
                    $(function () {
